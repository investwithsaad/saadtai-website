    ...
    "itemListElement": [
      {
        ...
        "url": `${BASE_URL}/investing/multifamily-investment-guide`
      },
      {
        "@type": "ListItem",
        "position": 2,
        "name": "Cap Rate Guide",
        "url": `${BASE_URL}/investing/cap-rate-guide`
      },
      {
        "@type": "ListItem",
        "position": 3,
        "name": "Albany NY Multifamily Investing",
        "url": `${BASE_URL}/investing/albany-multifamily-investing`
      },
      {
        "@type": "ListItem",
        "position": 4,
        ...
        <Container>
          <div ref={guidesRef}>
            ...
            <StaggerContainer className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              ...
              <FadeIn>
                <a href="/investing/multifamily-investment-guide" className="block h-full">
              ...
              {/* Cap Rate Guide */}
              <FadeIn delay={0.1}>
                <a href="/investing/cap-rate-guide" className="block h-full">
                  <Card color="dark" className="h-full hover:shadow-lg transition-shadow cursor-pointer">
        ...
        <Container>
          <div ref={marketsRef}>
            ...
            <StaggerContainer className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {/* Albany Guide */}
              <FadeIn>
                <a href="/investing/albany-multifamily-investing" className="block h-full">
                  <Card className="h-full hover:shadow-lg transition-shadow cursor-pointer border-l-4" style={{ borderColor: COLORS.dark }}>
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <span className="text-lg font-bold text-blue-600">7.2-7.8%</span>
                    </div>
                    ...
                    <div className="space-y-2 text-xs text-slate-600">
                      <div>📍 Median Price: <strong>$285K</strong></div>
                      <div>📈 Appreciation: <strong>+4.0% YoY</strong></div>
                      <div>🏘️ 2BR Rent: <strong>$1,550/mo</strong></div>
                    </div>
                  </Card>
                </a>
              </FadeIn>
              ...
              {/* Schenectady Guide */}
              <FadeIn delay={0.1}>
                <a href="/investing/schenectady-multifamily-investing" className="block h-full">
                  <Card className="h-full hover:shadow-lg transition-shadow cursor-pointer border-l-4" style={{ borderColor: '#15803d' }}>
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <span className="text-lg font-bold" style={{ color: '#15803d' }}>7.5-8.2%</span>
                    </div>
                    ...
                    <div className="space-y-2 text-xs text-slate-600">
                      <div>📍 Median Price: <strong>$279K</strong></div>
                      <div>📈 Appreciation: <strong>+9.8% YoY</strong></div>
                      <div>🏘️ 2BR Rent: <strong>$1,471-$1,695/mo</strong></div>
                    </div>
                  </Card>
                </a>
              </FadeIn>
              ...
              {/* Troy Guide */}
              <FadeIn delay={0.2}>
                <a href="/investing/troy-multifamily-investing" className="block h-full">
                  <Card className="h-full hover:shadow-lg transition-shadow cursor-pointer border-l-4" style={{ borderColor: '#a855f7' }}>
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <span className="text-lg font-bold text-purple-600">7.8-8.5%</span>
                    </div>
                    <p className="text-xs text-slate-600 mb-4 font-semibold">Cap Rate Range</p>
                    <Text className="text-sm text-slate-600 mb-4">
                    ...
                    <div className="space-y-2 text-xs text-slate-600">
                      <div>📍 Median Price: <strong>$275K</strong></div>
                      <div>📈 Appreciation: <strong>+5.2% YoY</strong></div>
                      <div>🏘️ 2BR Rent: <strong>$1,350-$1,550/mo</strong></div>
                    </div>
                  </Card>
                </a>
              </FadeIn>

...
export default function SellerPage() {
  ...
  const ctaRef = useScrollTracking({ sectionName: 'seller_cta' })
            ...
            <div className="max-w-3xl mx-auto text-center pb-8 pt-16">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                <Button
                  ...
                  image="/saad.png"
                  onClick={() => {
                    trackEvent('cta_clicked', { location: 'seller_hero', label: 'Request an Exit Strategy Review' })
                    setIsModalOpen(true)
                  }}
                >
            ...
            <FadeIn>
              <div>
                ...
                <Button
                  variant="default"
                  onClick={() => {
                    trackEvent('cta_clicked', { location: 'seller_expertise', label: 'Get the Game Plan' })
                    setIsModalOpen(true)
                  }}
                >
                  Get the Game Plan →
        ...
        <Container>
          ...
          <div className="flex justify-center mt-8">
            <Button
              ...
              image="/saad.png"
              onClick={() => {
                trackEvent('cta_clicked', { location: 'seller_cta', label: 'Lets Talk' })
                setIsModalOpen(true)
              }}
            >
          ...
          <div ref={processRef}>
            ...
            <FadeIn delay={0.2}>
              <div className="max-w-3xl mx-auto space-y-6">
                {[
                  { num: '1', title: 'Professional Photography & Virtual Tour', desc: 'High-quality imaging and virtual tour of your home to make a powerful first impression' },
                  { num: '2', title: 'Strategic Online Marketing', desc: 'Targeted marketing across 150+ sites to reach serious buyers and investors in your market' },
                  { num: '3', title: 'Targeted Buyer Outreach', desc: 'Direct email and personal contact with qualified investor buyers before public listing' },
                  { num: '4', title: 'Open Houses & Private Showings', desc: 'Organized showings and open houses designed to attract serious, ready-to-move buyers' },
                  { num: '5', title: 'Negotiation Strategy', desc: 'Strategic negotiation approach to maximize your sale price and favorable closing terms' },
                  { num: '6', title: 'Closing Coordination & Walkthrough', desc: 'Expert coordination of inspections, appraisals, title work, and final walkthrough to close efficiently' }
                ].map((step, idx) => (
